...
<body>
	<form method="post" action="/lesson02/ex03_1.jsp">
		...
		3. 강아지 or 고양이?
		<label>강아지 <input type="radio" name="animal" value="dog" checked></label>  <!-- 글자를 선택해도 클릭이 가능한 label 태그 -->
		<label>고양이 <input type="radio" name="animal" value="cat"></label>  <!-- 글자를 선택해도 클릭이 가능한 label 태그 --><br><br>
